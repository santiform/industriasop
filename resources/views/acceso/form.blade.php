<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="id_tipo_funcionamiento" class="form-control @error('id_tipo_funcionamiento') is-invalid @enderror" value="{{ old('id_tipo_funcionamiento', $acceso?->id_tipo_funcionamiento) }}" id="id_tipo_funcionamiento" placeholder="Id Tipo Funcionamiento">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="id_tipo_control" class="form-control @error('id_tipo_control') is-invalid @enderror" value="{{ old('id_tipo_control', $acceso?->id_tipo_control) }}" id="id_tipo_control" placeholder="Id Tipo Control">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="id_tipo_puerta" class="form-control @error('id_tipo_puerta') is-invalid @enderror" value="{{ old('id_tipo_puerta', $acceso?->id_tipo_puerta) }}" id="id_tipo_puerta" placeholder="Id Tipo Puerta">
