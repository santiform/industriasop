...
<div class="formulario">
  ...
  <form action="{{ route('newPaso9') }}" method="POST" onsubmit="prepararEnvio(this)" required>
    @csrf
    ...
    <div class="form-group">
        ...
        <input required  type="number" name="paradas" class="form-control" min="1" max="8">
    </div>

    <div class="form-group">
        <label for="subsuelos">Cantidad de subsuelos</label>
        <input required  type="number" name="subsuelos" class="form-control" min="1" max="5">
    </div>
    ...
    @if ($tipo_funcionamiento == 2) <div class="form-group">
        ...
        <input required  type="number" name="paradas" class="form-control">
    </div>

    <div class="form-group">
        <label for="subsuelos">Cantidad de subsuelos</label>
        <input required  type="number" name="subsuelos" class="form-control">
    </div>
