...
<div class="formulario">
  ...
  <form action="{{ route('newPaso12') }}" method="POST" >
    ...
    <input required  type="hidden" name="motor_encoder" value="<?php echo htmlspecialchars($motor_voltaje, ENT_QUOTES, 'UTF-8'); ?>">
    ...
    <input required  type="hidden" name="vista" value="<?php echo htmlspecialchars($vista, ENT_QUOTES, 'UTF-8'); ?>">
    ...
    <input required  type="hidden" name="placa_cabina" value="<?php echo htmlspecialchars($placa_cabina, ENT_QUOTES, 'UTF-8'); ?>">
    <input required  type="hidden" name="indicador_cabina" value="<?php echo htmlspecialchars($indicador_cabina, ENT_QUOTES, 'UTF-8'); ?>">
    <input required  type="hidden" name="indicador_pb" value="<?php echo htmlspecialchars($indicador_pb, ENT_QUOTES, 'UTF-8'); ?>">
    <input required  type="hidden" name="indicador_palier" value="<?php echo htmlspecialchars($indicador_palier, ENT_QUOTES, 'UTF-8'); ?>">

    <!-- este grupo en la bd se guarda en la tabla "habilitaciones_accesos" -->
    <input required  type="hidden" name="estadoBotones" value="{{ htmlspecialchars(json_encode($estadoBotones), ENT_QUOTES, 'UTF-8') }}">
